...
public class ListDashboardBerita extends RecyclerView.Adapter<ListDashboardBerita.ViewHolder>{
    ...
    public ListDashboardBerita(List<Berita> myDataset, Context context) {
        mDataset = myDataset;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_dashboard_berita, parent, false);
    ...
    @Override
    public void onBindViewHolder(final ListDashboardBerita.ViewHolder holder, int position) {
        // - get element from your dataset at this position
        // - replace the contents of the view with that element

        ImageView imageView = holder.v.findViewById(R.id.ivdashberita);
        ...
        TextView textView = holder.v.findViewById(R.id.tvjuduldash);
